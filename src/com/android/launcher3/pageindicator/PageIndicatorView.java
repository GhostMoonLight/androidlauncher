package com.android.launcher3.pageindicator;
...
public class PageIndicatorView extends View implements ViewPager.OnPageChangeListener {
    ...
    private int radiusPx = Util.dip2px(DEFAULT_RADIUS_DP);
    private int paddingPx = Util.dip2px(DEFAULT_PADDING_DP);
    ...
    public void setPadding(int paddingDp) {
        paddingPx = Util.dip2px(paddingDp);
        invalidate();
    }
