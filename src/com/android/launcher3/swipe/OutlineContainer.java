...
public class OutlineContainer extends FrameLayout implements Animatable
{
	...
	private void init()
	{
		...
		mOutlinePaint.setStrokeWidth(Util.dip2px(2));
	...
	protected void dispatchDraw(Canvas canvas)
	{
		...
		int offset = Util.dip2px(5);
		if (mOutlinePaint.getColor() != SwitchViewPager.sOutlineColor)
		{
			mOutlinePaint.setColor(SwitchViewPager.sOutlineColor);
		}
