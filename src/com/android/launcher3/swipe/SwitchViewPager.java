...
public class SwitchViewPager extends ViewPager {
    ...
    public static final String TAG = "SwitchViewPager";
    ...
    public SwitchViewPager(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs,
                R.styleable.SwitchViewPager);
        int effect = ta.getInt(R.styleable.SwitchViewPager_style, 0);
        ...
        setFadeEnabled(ta.getBoolean(R.styleable.SwitchViewPager_fadeEnabled,
                false));
        setOutlineEnabled(ta.getBoolean(
                R.styleable.SwitchViewPager_outlineEnabled, false));
        setOutlineColor(ta.getColor(R.styleable.SwitchViewPager_outlineColor,
                Color.WHITE));
        switch (mEffect) {
            case Stack:
            case ZoomOut:
    ...
    protected void animateStack(View left, View right, float positionOffset,
        ...
        if (mState != State.IDLE) {
            if (right != null) {
                ...
                ViewHelper.setScaleX(right, mScale);
                ViewHelper.setScaleY(right, mScale);
                ViewHelper.setTranslationX(right, mTrans*0.66f);
            }
            if (left != null) {
                left.bringToFront();
            }
