...
public class LauncherAppState implements DeviceProfile.DeviceProfileCallbacks {
    ...
    public synchronized static LauncherAppState getInstance() {
        if (INSTANCE == null) {
    ...
    private LauncherAppState() {
        ...
        DisplayMetrics sDisplayMetrics = sContext.getResources().getDisplayMetrics();
    ...
    //确定设备配置文件后的回调，用来设置icon的大小
    @Override
    public void onAvailableSizeChanged(DeviceProfile grid) {
        Utilities.setIconSize(grid.iconSizePx);
        BitmapUtils.setIconSize(grid.iconSizePx);
    }
    
    /**
     * 是否不显示所有软件列表界面（也就是第二屏）
     * @return
     */
