...
//                    mCurrentSweepAngle / (360 - MIN_SWEEP_ANGLE * 2)));
    ...
    private Property<LoadCircleView, Float> mAngleProperty = new Property<LoadCircleView, Float>(Float.class, "angle") {
        @Override
        public Float get(LoadCircleView object) {
            return object.getCurrentGlobalAngle();
        }

        @Override
        public void set(LoadCircleView object, Float value) {
            object.setCurrentGlobalAngle(value);
        }
    };

    private Property<LoadCircleView, Float> mSweepProperty = new Property<LoadCircleView, Float>(Float.class, "arc") {
        @Override
        public Float get(LoadCircleView object) {
