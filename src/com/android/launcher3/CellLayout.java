...
public class CellLayout extends ViewGroup {
    ...
    boolean[][] mOccupied;  //该CellLayout被分成网格的二位数组，其中的元素为true表示该网格已经被占了，false表示空闲
    ...
    //celllayout中的child，该child中放置shortcut  foldericon  widget等组建
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        setPadding(getResources().getDimensionPixelOffset(R.dimen.work_cell_padding_left), getResources().getDimensionPixelOffset(R.dimen.work_cell_padding_top), 
				getResources().getDimensionPixelOffset(R.dimen.work_cell_padding_right), getBottom());
    ...
    public boolean addViewToCellLayout(View child, int index, int childId, LayoutParams params,
        ...
        if (child instanceof BubbleTextView) {
            ...
            if (mIsHotseat && getResources().getBoolean(R.bool.hotseat_title_show)){
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            View child = getChildAt(i);
            child.layout(left, top, r - l - getPaddingRight(), top + b - t);
        }
    }
    ...
    //把被拖拽的view在mOccupied中的位置值为false
    ...
    */
    ...
    //对于给定的单元格，获取与该单元格有交集的view
    private void getViewsIntersectingRegion(int cellX, int cellY, int spanX, int spanY,
            View dragView, Rect boundingRect, ArrayList<View> intersectingViews) {
        if (boundingRect != null) {
            boundingRect.set(cellX, cellY, cellX + spanX, cellY + spanY);
        }
        //intersectingViews 和 mIntersectingViews指向同一个对象
