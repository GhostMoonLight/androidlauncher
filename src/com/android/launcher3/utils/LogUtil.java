...
public class LogUtil {
    ...
    private LogUtil() {}
    private static String logStartStr = "AAAA";
	...
	public static void i(String tag, String msg) {
		try {
			if(DEBUG){
				android.util.Log.i(tag, logStartStr+msg);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void d(String tag, String msg) {
		try {
			if(DEBUG) {
				android.util.Log.d(tag, logStartStr+msg);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void w(String tag, String msg) {
		try {
			if(DEBUG) {
				android.util.Log.w(tag, logStartStr+msg);
//				Log.getInstance().saveLogToFile(tag, msg, null);
	...
	public static void w(String tag, String msg, Throwable tr) {
		try {
			if(DEBUG) {
				android.util.Log.w(tag, logStartStr+msg, tr);
//				Log.getInstance().saveLogToFile(tag, msg, tr);
	...
	public static void e(String tag, String msg) {
		try {
			android.util.Log.e(tag, logStartStr+msg);
//			Log.getInstance().saveLogToFile(tag, msg, null);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void e(String tag, String msg, Throwable tr) {
		try {
			android.util.Log.e(tag, logStartStr+msg, tr);
//			Log.getInstance().saveLogToFile(tag, msg, tr);
		} catch (Exception e) {
			e.printStackTrace();
		}
