 ...
 */
public class FolderSingleHandedAutoScrollHelper extends AutoScrollHelper {
    private static final float MAX_SCROLL_VELOCITY = 1500f;

    private final SingleHandedView mTarget;

    public FolderSingleHandedAutoScrollHelper(SingleHandedView target) {
        super(target);
