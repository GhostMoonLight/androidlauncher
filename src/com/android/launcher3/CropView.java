...
import com.android.launcher3.wallpaper.TiledImageRenderer.TileSource;
import com.android.launcher3.wallpaper.TiledImageView;
...
public class CropView extends TiledImageView implements OnScaleGestureListener {
    ...
    private float[] getImageDims() {
        final float imageWidth = mRenderer.source.getImageWidth();   //图片宽度
        final float imageHeight = mRenderer.source.getImageHeight(); //图片高度
