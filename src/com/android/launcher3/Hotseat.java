...
public class Hotseat extends FrameLayout {
    ...
    int getCellXFromOrder(int rank) {
        rank = hasVerticalHotseat() ? 0 : rank;
        if (!LauncherAppState.isDisableAllApps() && rank >= mAllAppsButtonRank)
        	rank++;
        return rank;
    }
    ...
    int getCellXAllAppsFolderFromOrder(int rank) {
    ...
    public boolean isAllAppsButtonRank(int rank) {
        if (LauncherAppState.isDisableAllApps()) {
            ...
            return getCellXFromOrder(rank) == mAllAppsButtonRank;
        }
    }
    ...
    void resetLayout() {
        ...
        if (!LauncherAppState.isDisableAllApps()) {
            ...
            int x = getCellXAllAppsFolderFromOrder(mAllAppsButtonRank);
    ...
    void addAllAppsFolder(IconCache iconCache,
        ...
        if (LauncherAppState.isDisableAllApps()) {
            ...
            fi.cellX = getCellXAllAppsFolderFromOrder(mAllAppsButtonRank);
    ...
    void addAppsToAllAppsFolder(ArrayList<AppInfo> apps) {
        if (LauncherAppState.isDisableAllApps()) {
            View v = mContent.getChildAt(getCellXAllAppsFolderFromOrder(mAllAppsButtonRank), getCellYFromOrder(mAllAppsButtonRank));
            FolderIcon fi = null;
