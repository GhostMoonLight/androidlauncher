...
import com.android.launcher3.wallpaper.BitmapRegionTileSource;
import com.android.launcher3.wallpaper.BitmapRegionTileSource.BitmapSource;
import com.android.launcher3.wallpaper.ExifInterface;
...
public class WallpaperCropActivity extends Activity {
    ...
    static protected Point getDefaultWallpaperSize(Resources res, WindowManager windowManager) {
        if (sDefaultWallpaperSize == null) {
            ...
            if (isScreenLarge(res)) {// 屏幕最短边大于720则被判定为大屏幕设备
