    ...
    private static void removeShortcut(Context context, Intent data) {
        ...
        if (intent != null && name != null) {
            ...
            Cursor c = cr.query(LauncherSettings.Favorites.CONTENT_URI,
                ...
                LauncherSettings.Favorites.TITLE + "=? and "+LauncherSettings.Favorites.ITEM_TYPE+"=?", new String[] { name, LauncherSettings.BaseLauncherColumns.ITEM_TYPE_SHORTCUT+""}, null);
