...
class ChineseToPinyinResource
{
     ...
     */
	static ChineseToPinyinResource getInstance(Context context) {
		if (mInstance == null) {
			mInstance = new ChineseToPinyinResource(context);
		}
		return mInstance;
	}
...
//            getUnicodeToHanyuPinyinTable().load(ResourceHelper.getResourceInputStream(resourceName));
            ...
            setUnicodeToHanyuPinyinTable(new Properties());
            getUnicodeToHanyuPinyinTable().load(context.getAssets().open(resourceName));
